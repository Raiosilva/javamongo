package com.oliveira.javamongo.config;
...
import com.oliveira.javamongo.dto.AuthorDTO;
import com.oliveira.javamongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, 
				sdf.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!", 
				new AuthorDTO(maria));
